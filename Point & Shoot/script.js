...
window.addEventListener('load', function(){
    ...
    class Raven {
        constructor(){
            ...
            this.directionX = Math.random() * 8 + 5;
    ...
    class Explosion {
        ...
        draw(){
            ctx.drawImage(this.image, this.frame * this.spriteWidth, 0, this.spriteWidth, this.spriteHeigth, this.x, this.y - this.size * 0.25, this.size, this.size);
        }
    }
